<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\wamp\www\ppjianzhang./application/admin\view\banner\edit.html";i:1487144726;s:66:"D:\wamp\www\ppjianzhang./application/admin\view\public\layout.html";i:1492499367;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<input type='hidden' id='id' value='<?php echo $msg['id']; ?>'/>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>幻灯片标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $msg['show_name']; ?>" placeholder="" id="" name="show_name" style="width:50%">
			</div>
		</div>		
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" name="show_link" id="" placeholder="" value="<?php echo $msg['show_link']; ?>" class="input-text" style="width:50%">
				http://开头</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
					...
					<img width="60" class="product-thumb" src="<?php echo UPLODS; ?><?php echo $msg['show_img']; ?>">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $msg['sort']; ?>" placeholder="" id="" name="sort" style="width:50%">整数
			</div>
		</div>
		<div class="row cl">
