<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"D:\wamp\www\ppjianzhang./application/admin\view\product\edit.html";i:1492677424;s:66:"D:\wamp\www\ppjianzhang./application/admin\view\public\layout.html";i:1492499367;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<form action="edit?id=<?php echo $msg['id']; ?>" enctype="multipart/form-data" method="post" class="form form-horizontal" id="form_add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $msg['sort']; ?>" placeholder="" id="" name="sort">
			</div>
		</div>
