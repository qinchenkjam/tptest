<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"D:\wamp\www\ppjianzhang./application/admin\view\product\cate_index.html";i:1493277702;s:66:"D:\wamp\www\ppjianzhang./application/admin\view\public\layout.html";i:1492499367;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="pd-20 text-c">
  ...
  <form class="Huiform" name="form1" action="<?php echo url('admin/productCate/cateAdd'); ?>" method="post" onsubmit="return checksubmit()">
      ...
      <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <tr class="text-c">
          ...
          <td class="f-14">
           ...
           <?php if($vo['cat_id'] >= 3): ?>
           <a style="text-decoration:none" class="ml-5"  href="cateDel?cid=<?php echo $vo['cat_id']; ?>" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>
           <?php endif; ?>
          </td>
        </tr>
        <?php endforeach; endif; else: echo "" ;endif; ?>
