<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:64:"D:\wamp\www\ppjianzhang./application/admin\view\index\index.html";i:1493372155;}*/ ?>
﻿<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
				  ...
				  <li>  <a href="<?php echo url('index/index/index'); ?>" target="_blank">网站首页</a></li>
					...
					<li class="dropDown dropDown_hover"> <a href="#" class="dropDown_A">admin <i class="Hui-iconfont">&#xe6d5;</i></a>
						<ul class="dropDown-menu menu radius box-shadow">
							<li><a href="#">个人信息</a></li>
							<!-- <li><a href="#">切换账户</a></li> -->
							<li><a href="#" onClick="log_out()">退出</a></li>
						</ul>
					</li>
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo url('admin/ArticleCate/index'); ?>" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>	
					<li><a _href="<?php echo url('admin/Article/index'); ?>" data-title="资讯管理" href="javascript:void(0)">资讯管理</a></li>
				</ul>
			</dd>
		</dl>
		<!-- <dl id="menu-picture">
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a _href="<?php echo url('admin/productCate/index'); ?>" data-title="分类管理" href="javascript:void(0)">分类管理</a></li>
					<li><a _href="<?php echo url('admin/product/index'); ?>" data-title="产品管理" href="javascript:void(0)">产品管理</a></li>
				</ul>
			</dd>
		</dl>
		<!-- <dl id="menu-comments">
		...
		<?php if(\think\Session::get('aid') == 1): ?>
		<dl id="menu-admin">
			<dt><i class="Hui-iconfont">&#xe62d;</i> 管理员管理<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					<!-- <li><a _href="<?php echo url('admin/product/cateIndex'); ?>" data-title="角色管理" href="javascript:void(0)">角色管理</a></li>
					<li><a _href="admin-permission.html" data-title="权限管理" href="javascript:void(0)">权限管理</a></li> -->
					<li><a _href="<?php echo url('admin/admin/index'); ?>" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
				</ul>
			</dd>
		</dl>
		<?php endif; ?>
		...
		<dl id="menu-system">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo url('admin/System/index'); ?>" data-title="系统设置" href="javascript:void(0)">系统设置</a></li>
					<li><a _href="<?php echo url('admin/Banner/index'); ?>" data-title="滚动图管理" href="javascript:void(0)">幻灯片管理</a></li>
					<li><a _href="<?php echo url('admin/FriendLink/index'); ?>" data-title="友情链接" href="javascript:void(0)">友情链接</a></li>
					<li><a _href="<?php echo url('admin/Page/index'); ?>" data-title="栏目管理" href="javascript:void(0)">单页面管理</a></li>
					<li><a _href="<?php echo url('admin/Template/inedex'); ?>?t=pc"  data-title="系统设置" href="javascript:void(0)">模板设置</a></li> 
					<li><a _href="<?php echo url('admin/Template/index'); ?>" data-title="系统设置" href="javascript:void(0)">模板设置</a></li>
					...
					<li><a _href="<?php echo url('admin/ActionLog/index'); ?>" data-title="系统日志" href="javascript:void(0)">系统日志</a></li>
				</ul>
			</dd>
		</dl>
	</div>
...
function log_out(){
    layer.confirm('确定要退出登陆？',{
        btn:['确定','取消']
    },
    function(){            
        $.getJSON("<?php echo url('admin/User/login_out'); ?>",function(data){
        	//console.log(data.status);
           if(data.status==-1){
               layer.msg(data.msg,{icon:1});
              location.href="<?php echo url('admin/User/login'); ?>";
           }
        });
    },function(){}
    );
